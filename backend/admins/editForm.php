...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if (!empty($_POST['id']) && !empty($_POST['name']) && !empty($_POST['surname']) && !empty($_POST['email']) && !empty($_POST['username']) && !empty($_POST['password1']) && !empty($_POST['password2'])) {
        ...
        if ($password1 != $password2) {
            $_SESSION['error_message'] = "passwords are not equal";
